...
## [ketanbot-robotic-bartender](https://github.com/elvitigalalis/ketanbot-robotic-bartender) 🔗
- Learn about specifics at the [KetanBot website](https://elvitigalalis.github.io/ketanbot-robotic-bartender/)
- Arduino, C++, Adafruit


<!-- ## [aachen-termin-bot](https://github.com/elvitigalalis/aachen-termin-bot) 🔗
...
## [visa-termin-alert](https://github.com/elvitigalalis/visa-termin-alert) 🔗
...
## [images-viewer](https://github.com/elvitigalalis/images-viewer) 🔗
- A simple images viewer, scroll all images in one go.
- React, Javascript
- Hosted on [Github Pages](https://elvitigalalis.github.io/images-viewer/) 

## [react-vscode-portfolio](https://github.com/elvitigalalis/react-vscode-portfolio) 🔗
- What you are looking at now
- A vscode inspired portfolio project
- Responsive Web Design 
- React, TypeScript

## [go-germany](https://elvitigalalis.github.io/go-germany/) 🔗
...
- The whole project consists of three repositories, [go-germany](https://github.com/elvitigalalis/go-germany), [go-germany-api](https://github.com/elvitigalalis/go-germany-api), and [go-germany-sync](https://github.com/elvitigalalis/go-germany-sync), which are the frontend, the backend, and the data synchronization tool respectively.
  - go-germany
...
## [blog](https://github.com/elvitigalalis/blog) 🔗
- The blog I built based on [docusaurus](https://github.com/elvitigalalis/blog) to document my learning progress and to share the add-ins I created which were used to increase my efficiency at work.
- Javascript, React, Docusaurus

## [notion-pdf](https://github.com/elvitigalalis/notion-pdf) 🔗
...
## [eyny-novel](https://github.com/elvitigalalis/eyny-novel) 🔗
- A novel downloader
- Python, Beautiful Soup

## [react-flask-mysql-example](https://github.com/elvitigalalis/react-flask-mysql-example) 🔗
...
## [Excel-starter](https://github.com/elvitigalalis/Excel-Starter) 🔗
...
## [pybecker](https://github.com/elvitigalalis/pybecker) 🔗
...
## [PDF2Excel](https://github.com/elvitigalalis/PDF2Excel) 🔗
...
## [TickMark](https://github.com/elvitigalalis/TickMark) 🔗
...
- Page: [TickMark Demo](https://elvitigalalis.github.io/tickmark_demo/)
- Demo: https://youtu.be/Hi4jG4As_h8
- VB.NET

## [Commercial Law App](https://github.com/elvitigalalis/CommercialLaw) 🔗
- My first mobile application aimed at helping myself to prepare the CPA Exam in spare time.
- Java

## [Liu Input Method Tutorial](https://elvitigalalis.github.io/learnliu/) 🔗
